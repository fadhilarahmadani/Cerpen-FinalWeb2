...
<body >
      ...
      <section class="bg-gray-100">
        <div class="max-w-screen-xl px-4 py-8 pt-56 mx-auto mt-10 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            <div class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
              <img
                alt=""
                src="{{ asset('buku.jpeg') }}"
                class="inset-0 object-cover w-full h-full " style="z-index: -1"
              />
            </div>
            ...
            <div class="lg:py-24">
              ...
              <p class="mt-4 text-gray-600">
                Discover a world of captivating short stories crafted by talented writers. Our collection spans various genres, offering something for every reader. Dive into these tales and let your imagination soar as you explore the emotions, adventures, and experiences within each narrative. Enjoy the journey through our stories, where every read is a new adventure.
            </p>
...
<!-- Alert Popup -->
<div id="alertPopup" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
    <div class="w-full max-w-sm p-8 bg-white rounded-lg shadow-lg">
        ...
        @endif
        <button onclick="document.getElementById('alertPopup').classList.add('hidden')" class="w-full py-2 mt-4 text-center text-gray-600 underline">
            Close
        </button>
    </div>
</div>
      ...
      <h1 id="stories" class="text-center bold-24" style="font-size: 2.5rem; height: 15vh; display: flex; align-items: center; justify-content: center; margin: 0;">
        Story Selections for You</h1>
          <div  class="container grid grid-cols-4 gap-4 mx-auto max-w-xxl">
            ...
            <a href="{{ route('user.read', $story->id) }}" class="block group">
                ...
                <div class="mt-3">
                    ...
                    @if($story->is_premium)
                        <span class="inline-block px-2 py-1 mt-2 text-xs font-bold text-white bg-yellow-500 rounded-full">Premium</span>
                    @endif
                </div>
            </a>
            @endforeach
    ...
    <footer class="bg-gray-100">
        <div class="max-w-5xl px-4 py-4 mx-auto sm:px-6 lg:px-8">
          <div class="justify-center text-teal-600 justify">
