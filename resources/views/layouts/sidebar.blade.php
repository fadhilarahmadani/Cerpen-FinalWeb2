...
<body>
<header>
    <div class="fixed z-10 flex items-center justify-between w-full p-2 bg-white shadow-md">
        ...
        <div class="flex items-center gap-4">
            <form action="{{ route('search.admin') }}" method="GET" class="flex items-center">
                <input type="search" name="query" placeholder="Search" class="w-24 px-3 py-2 bg-gray-200 border border-gray-300 rounded-lg md:w-auto focus:outline-none focus:border-blue-500" value="{{ request('query') }}" />
            </form>
            <div class="relative">
